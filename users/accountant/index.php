					...
					<nav class="navbar  navbar-expand-lg">
						...
						<div>
							<?php 
								...
								$account = $_SESSION['accountant_name'];
								$sql = "SELECT * FROM (users INNER JOIN branches ON users.branch_id = branches.branch_id) WHERE username = '$account'";
							...
							?>
							<p class="justify-content-end"><?php echo $account . " | " . $role . " | " . $branch; ?></p>
						</div>
